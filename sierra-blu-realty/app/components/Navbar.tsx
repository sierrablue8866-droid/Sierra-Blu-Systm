      ...
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            <div className="w-10 h-10 border-2 border-cyan/60 rounded-full flex items-center justify-center p-1 overflow-hidden transition-all duration-300 group-hover:border-cyan group-hover:shadow-[0_0_20px_var(--cyan-glow)] bg-black/20 backdrop-blur-sm">
               <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-cyan transition-colors duration-300">
